        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    ...
                    <li><a style="font-size:20px;" href="kasus" class="nav-link px-2 text-white">Kasus</a></li>
                    <li><a style="font-size:20px;margin-left:20px" href="cekstatus" class="nav-link px-2 text-white">Cek Status Laporan</a></li>
                </ul>
                <div class="text-end">
                    @guest
